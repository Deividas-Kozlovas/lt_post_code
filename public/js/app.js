...
/* harmony import */ var _models_renderForm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/renderForm */ "./src/models/renderForm.js");
/* harmony import */ var _models_searchCode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/searchCode */ "./src/models/searchCode.js");


(0,_models_renderForm__WEBPACK_IMPORTED_MODULE_0__["default"])();
(0,_models_searchCode__WEBPACK_IMPORTED_MODULE_1__["default"])();

// const students = ["Ieva", "Mantas", "Kajus"];
// localStorage.setItem("srudents", students);

console.log(localStorage.getItem("srudents"));
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form */ "./src/models/form.js");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ajaxService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ajaxService */ "./src/models/ajaxService.js");

var searchCode = function searchCode() {
  document.querySelector("form").addEventListener("submit", function (e) {
    e.preventDefault();
    var searchTerm = document.querySelector(".term").value;
    var cachedPostalCode = localStorage.getItem(searchTerm);
    if (cachedPostalCode) {
      ...
      (0,_ajaxService__WEBPACK_IMPORTED_MODULE_0__["default"])(searchTerm).then(function (result) {
        if (result && result.status === "success" && result.success && result.data.length > 0) {
          var postalCode = result.data[0].post_code;
        ...
        document.querySelector(".result").value = "Error fetching postal code";
      });
    }
  });
};
